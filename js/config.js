...
var WHEEL_CONFIGS = {
  anfaenger: {
    ...
    title: "Anfänger",
    segments: [
      { label: "Solokünstler/Gruppe", shorthand: "♫",   color: "#00e676", glow: "#69ff97" },
  ...
  profi: {
    ...
    title: "Profi",
    segments: [
      { label: "Songtitel",           shorthand: "🎵",   color: "#00e676", glow: "#69ff97" },
      { label: "Genaues Jahr",        shorthand: "Jahr", color: "#ff4081", glow: "#ff80ab" },
      { label: "Künstler/Bandname",   shorthand: "🎤",   color: "#ffea00", glow: "#ffff56" },
      { label: "Jahrzehnt",           shorthand: "10s",  color: "#b388ff", glow: "#d1c4e9" },
